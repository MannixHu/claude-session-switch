...
const dictionaries = {
  "zh-CN": {
    ...
    status_session_hidden_invalid: "该会话无法恢复，已在左侧隐藏。",
    ...
    menu_stop: "停止",
    menu_delete: "删除",
    confirm_update_available: "发现新版本 {latest}（当前 {current}）。现在下载并打开安装包吗？",
    ...
    update_dialog_subtitle: "查看版本内容，并在这里直接开始下载。",
    ...
    update_dialog_no_release_notes: "这个版本没有额外的发布说明。",
  ...
  "en-US": {
    ...
    status_session_alias_saved: "Saved sidebar session label: {name}",
    status_session_alias_cleared: "Restored the default session label.",
    status_session_hidden_invalid: "This session could not be resumed and has been hidden from the sidebar.",
    ...
    status_update_busy: "An update check is already in progress.",
    status_update_checking: "Checking for updates…",
    status_update_up_to_date: "You're already on the latest version: {version}",
    status_update_downloading: "Downloading update: {version}",
    status_update_installer_opened: "Opened installer for {version}",
    status_update_failed: "Update failed: {message}",
    status_open_release_failed: "Failed to open release page: {message}",
    ...
    update_dialog_subtitle: "Review the release contents and start the download from here.",
    ...
    update_dialog_description: "Description",
    update_dialog_release_notes: "Release Notes",
    update_dialog_no_release_notes: "No extra release notes were provided for this version.",
