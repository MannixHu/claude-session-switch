...
function Te(r5) {
  return O == null ? void 0 : O.trackDisposable(r5), r5;
}
function ve(r5) {
  O == null ? void 0 : O.markAsDisposed(r5);
}
function he(r5, e) {
  O == null ? void 0 : O.setParent(r5, e);
}
function et(r5, e) {
...
((Q) => {
  ...
  function e(l) {
    if (rt) {
      ...
      l.onDidAddListener = () => {
        ++s === 2 && (console.warn("snapshotted emitter LIKELY used public and SHOULD HAVE BEEN created with DisposableStore. snapshotted here"), a.print()), i == null ? void 0 : i();
      };
    }
  }
  function t(l, i) {
  ...
  function D(l, i) {
    ...
    i || e(s);
    let x = new C(s);
    return i == null ? void 0 : i.add(x), x.event;
  }
  function T(l, i) {
  ...
  function B(l, i, a = 100, s = false, x = false, c, h) {
    ...
    h || e(Ce);
    let q = new C(Ce);
    return h == null ? void 0 : h.add(q), q.event;
  }
  Q.debounce = B;
  function L(l, i = 0, a) {
  ...
  function k(l, i = false, a = [], s) {
    ...
    s && s.add(c);
    let h = () => {
      x == null ? void 0 : x.forEach((y) => F.fire(y)), x = null;
...
var C = class {
  constructor(e) {
    var _a, _b, _c, _d;
    this._size = 0;
    this._options = e, this._leakageMon = We > 0 || ((_a = this._options) == null ? void 0 : _a.leakWarningThreshold) ? new Ee((e == null ? void 0 : e.onListenerError) ?? Y, ((_b = this._options) == null ? void 0 : _b.leakWarningThreshold) ?? We) : void 0, this._perfMon = ((_c = this._options) == null ? void 0 : _c._profName) ? new be(this._options._profName) : void 0, this._deliveryQueue = (_d = this._options) == null ? void 0 : _d.deliveryQueue;
  }
  dispose() {
    var _a, _b, _c, _d;
    if (!this._disposed) {
      if (this._disposed = true, ((_a = this._deliveryQueue) == null ? void 0 : _a.current) === this && this._deliveryQueue.reset(), this._listeners) {
        if (Ve) {
          let e = this._listeners;
          queueMicrotask(() => {
            at(e, (t) => {
              var _a2;
              return (_a2 = t.stack) == null ? void 0 : _a2.print();
            });
          });
        }
  ...
  get event() {
    return this._event ?? (this._event = (e, t, n) => {
      ...
      if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
        ...
        return (((_a = this._options) == null ? void 0 : _a.onListenerError) || Y)(D), _.None;
      }
      if (this._disposed) return _.None;
      t && (e = e.bind(t));
      let o = new N(e), d, v;
      this._leakageMon && this._size >= Math.ceil(this._leakageMon.threshold * 0.2) && (o.stack = K.create(), d = this._leakageMon.check(o.stack, this._size + 1)), Ve && (o.stack = v ?? K.create()), this._listeners ? this._listeners instanceof N ? (this._deliveryQueue ?? (this._deliveryQueue = new Fe()), this._listeners = [this._listeners, o]) : this._listeners.push(o) : ((_c = (_b = this._options) == null ? void 0 : _b.onWillAddFirstListener) == null ? void 0 : _c.call(_b, this), this._listeners = o, (_e = (_d = this._options) == null ? void 0 : _d.onDidAddFirstListener) == null ? void 0 : _e.call(_d, this)), this._size++;
      let E = me(() => {
        re == null ? void 0 : re.unregister(E), d == null ? void 0 : d(), this._removeListener(o);
      });
...
`).trim(), b = /(file:|vscode-file:\/\/vscode-app)?(\/[^:]*:\d+:\d+)/.exec(p);
        re.register(E, (b == null ? void 0 : b[2]) ?? p, E);
      }
      return E;
    }), this._event;
  }
  ...
  _deliver(e, t) {
    var _a;
    if (!e) return;
    let n = ((_a = this._options) == null ? void 0 : _a.onListenerError) || Y;
    if (!n) {
      e.value(t);
      return;
    }
  ...
  fire(e) {
    var _a, _b, _c, _d;
    if (((_a = this._deliveryQueue) == null ? void 0 : _a.current) && (this._deliverQueue(this._deliveryQueue), (_b = this._perfMon) == null ? void 0 : _b.stop()), (_c = this._perfMon) == null ? void 0 : _c.start(this._size), this._listeners) if (this._listeners instanceof N) this._deliver(this._listeners, e);
    else {
